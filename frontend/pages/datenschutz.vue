<template>
  <div class="container">
    ...
    <div style="margin-top: 24px;">
      ...
      <h2 style="margin-top: 32px;">2. Allgemeine Hinweise und Pflicht­informationen</h2>
      <p class="muted">
      ...
      <h2 style="margin-top: 32px;">3. Ihre Rechte als Betroffener</h2>
      <p class="muted">
      ...
      <h2 style="margin-top: 32px;">4. Datenerfassung auf dieser Website</h2>
      <p class="muted">
